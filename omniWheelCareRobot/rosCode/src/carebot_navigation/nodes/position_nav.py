...
class PositionNav():  
	...
	locations['one'] = Pose(Point(0.3778,1.4242,0.0), Quaternion(0.0,0.0,-0.6996,0.7144))
        locations['two'] = Pose(Point(1.1783,0.5203,0.0), Quaternion(0.0,0.0,0.0219,0.9997))
        locations['three'] = Pose(Point(1.7969,1.2527,0.0), Quaternion(0.0,0.0,-0.6997,0.7144))
        locations['four'] = Pose(Point(1.7788,0.0390,0.0), Quaternion(0.0,0.0,0.7324,0.6809))
        locations['back'] = Pose(Point(0.0446,-0.009,0.0), Quaternion(0.0,0.0,0.0044,0.9999))
