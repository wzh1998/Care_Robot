...
(cl:in-package arduino_integration-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IOTnet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IOTnet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arduino_integration-msg:<IOTnet> is deprecated: use arduino_integration-msg:IOTnet instead.")))

(cl:ensure-generic-function 'netcmd-val :lambda-list '(m))
(cl:defmethod netcmd-val ((m <IOTnet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arduino_integration-msg:netcmd-val is deprecated.  Use arduino_integration-msg:netcmd instead.")
  (netcmd m))
