...
set(MSG_I_FLAGS "-Ibaidu_speech:/home/sz/ros_voice_system/src/baidu_speech/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sz/ros_voice_system/src/baidu_speech/msg/TTS_message.msg" NAME_WE)
add_custom_target(_baidu_speech_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "baidu_speech" "/home/sz/ros_voice_system/src/baidu_speech/msg/TTS_message.msg" "std_msgs/Header:std_msgs/String"
)
...
_generate_msg_cpp(baidu_speech
  "/home/sz/ros_voice_system/src/baidu_speech/msg/TTS_message.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/baidu_speech)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/baidu_speech\")")
  # install generated code
  install(
